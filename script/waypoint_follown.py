...
def main():
    ...
    initial_pose.pose.position.x = -0.008256327669814585
    initial_pose.pose.position.y = 0.012011860254134317
    initial_pose.pose.orientation.z = -0.015022756795297748
    initial_pose.pose.orientation.w = 0.9998871520218016
    ...
    file_path = '/home/franklin/ws/src/my_bot/script/test10.json'
    goal_poses = []
